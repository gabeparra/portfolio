...
const MISSIONS = [
  ...
  },
  {
    ...
    name: 'ChessKids',
    class: 'GAMES',
    desc: 'Kids’ chess in Unreal Engine 5.7 — holographic board, neon per-piece arenas, embedded Pulse C++ engine, plus Story Mode, Puzzle Mode, and scripted tutorials with ElevenLabs VO. Senior design capstone; the long private remake (chesscadetsremake) is where the full game lives.',
    metrics: ['senior capstone', 'story + puzzle modes', 'Pulse C++ engine'],
    stack: ['Unreal Engine 5.7', 'C++', 'Pulse', 'Lumen / Ray Tracing'],
  ...
  },
  {
    ...
    class: 'GAMES',
    desc: 'Western twin-stick shooter for Android in Unity 6. Touch twin-stick with an auto-fire aim zone, landscape lock, Classic / TopDown / FPS views, and a headless IL2CPP pipeline that lands APKs on-device through Ares Control. Public itch.io build targeted for end of October — repo stays private for licensed asset packs.',
    metrics: ['itch.io APK Oct 2026', 'ARM64 · IL2CPP', '3 view modes'],
